      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 rounded-xl bg-brand-500 px-4 py-2.5 text-sm font-semibold text-grafito-900 dark:text-white hover:bg-brand-600 transition-all"
          >
        ...
        <div className="rounded-2xl border border-grafito-200 dark:border-white/5 bg-white dark:bg-grafito-900/60 p-6 backdrop-blur-md space-y-4">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex items-center justify-between rounded-xl bg-grafito-100 dark:bg-grafito-800/40 p-3 border border-grafito-200 dark:border-white/5">
                <div>
                  <p className="text-sm font-semibold text-grafito-900 dark:text-white">{p.name}</p>
                  <p className="text-[10px] text-grafito-500 dark:text-grafito-400">Mínimo sugerido: {p.min} unidades</p>
                </div>
        ...
        <div className="rounded-2xl border border-grafito-200 dark:border-white/5 bg-white dark:bg-grafito-900/60 p-6 backdrop-blur-md space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between border-b border-grafito-200 dark:border-white/5 pb-2">
              <span className="text-sm text-grafito-500 dark:text-grafito-400">Costo total de inventario:</span>
              <span className="text-sm font-bold text-grafito-900 dark:text-white">$4,850.00</span>
            </div>
            <div className="flex justify-between border-b border-grafito-200 dark:border-white/5 pb-2">
              <span className="text-sm text-grafito-500 dark:text-grafito-400">Venta estimada de inventario:</span>
              <span className="text-sm font-bold text-brand-400">$8,240.00</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-grafito-500 dark:text-grafito-400">Margen promedio estimado:</span>
