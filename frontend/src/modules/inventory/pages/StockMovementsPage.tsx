  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Movimientos de Stock</h1>
          <p className="text-sm text-grafito-400">Registro histórico de entradas, salidas y ajustes de inventario.</p>
        </div>
      </div>
          ...
          <tbody className="divide-y divide-white/5">
            {[
              ...
              <tr key={i} className="hover:bg-white/5 transition-colors">
                ...
                <td className="py-3 font-semibold text-white">{m.product}</td>
                <td className="py-3">
