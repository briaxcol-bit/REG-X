  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-sm text-grafito-400">Consola de administración para la plataforma global de REG-X.</p>
      </div>

      <div className="grid gap-6 md:grid-cols-3">
        <div className="rounded-2xl border border-white/5 bg-grafito-900/60 p-6 backdrop-blur-md space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-semibold text-white">Estado de Servidores</h3>
            <Server className="h-5 w-5 text-emerald-400" />
          </div>
          <p className="text-3xl font-bold text-white">99.98%</p>
          <p className="text-xs text-grafito-400">Uptime global en las últimas 24 horas.</p>
        </div>

        <div className="rounded-2xl border border-white/5 bg-grafito-900/60 p-6 backdrop-blur-md space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-semibold text-white">Bases de Datos Activas</h3>
            <Database className="h-5 w-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-white">3,240</p>
          <p className="text-xs text-grafito-400">Instancias de Tenants aprovisionadas.</p>
        </div>

        <div className="rounded-2xl border border-white/5 bg-grafito-900/60 p-6 backdrop-blur-md space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-semibold text-white">Solicitudes por Minuto</h3>
            <Activity className="h-5 w-5 text-brand-400" />
          </div>
          <p className="text-3xl font-bold text-white">12,450 rpm</p>
          <p className="text-xs text-grafito-400">Tráfico balanceado correctamente.</p>
        </div>
      </div>
