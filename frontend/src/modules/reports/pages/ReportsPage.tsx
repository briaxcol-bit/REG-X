  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col justify-between rounded-2xl border border-grafito-200 dark:border-white/5 bg-white dark:bg-grafito-900/60 p-6 backdrop-blur-md space-y-4 opacity-60">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-grafito-900 dark:text-white">Reporte de Inventario</h3>
            <BarChart3 className="h-5 w-5 text-blue-400" />
          </div>
          <p className="text-sm text-grafito-500 dark:text-grafito-400">Rotación de stock, productos más vendidos y valorización.</p>
        </div>
        ...
        <div className="flex flex-col justify-between rounded-2xl border border-grafito-200 dark:border-white/5 bg-white dark:bg-grafito-900/60 p-6 backdrop-blur-md space-y-4 opacity-60">
          ...
          <p className="text-sm text-grafito-500 dark:text-grafito-400">Análisis detallado de rentabilidad por producto y categoría.</p>
        </div>
      </div>
    </div>
  )
