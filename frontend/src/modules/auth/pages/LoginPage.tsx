...
function GlassInput({ children }: { children: React.ReactNode }) {
  ...
  const handleFocus = async () => {
    // Efecto gelatina: squeeze → stretch → settle
  ...
  return (
    ...
    >
      {/* Línea de brillo superior — el "canto" del cristal */}
      <div
      ...
      <div
        className="pointer-events-none absolute left-0 inset-y-2 w-px rounded-full"
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-lg max-h-[80vh] overflow-y-auto rounded-2xl border border-white/10 bg-grafito-900 p-8 shadow-2xl"
        >
          {/* Header */}
          <div className="mb-6 flex items-start justify-between gap-4">
            ...
            <button
              onClick={onClose}
              className="shrink-0 rounded-lg p-1.5 text-grafito-500 hover:bg-white/5 hover:text-white transition-colors"
            >
              <X className="h-5 w-5" />
            </button>
          </div>

          <div className="space-y-5 text-sm text-grafito-300 leading-relaxed">

            <section>
              <h3 className="font-semibold text-white mb-2">1. Responsable del Tratamiento</h3>
              <p>
                <strong className="text-grafito-200">REG-X SaaS Enterprise</strong> es el responsable del tratamiento
            ...
            <section>
              <h3 className="font-semibold text-white mb-2">2. Datos Recolectados</h3>
              <p>REG-X recopila los siguientes datos al usar la plataforma:</p>
              <ul className="mt-2 space-y-1 ml-4 list-disc text-grafito-400">
            ...
            <section>
              <h3 className="font-semibold text-white mb-2">3. Finalidades del Tratamiento</h3>
            ...
            <section>
              <h3 className="font-semibold text-white mb-2">4. Almacenamiento y Seguridad</h3>
              <p>
            ...
            <section>
              <h3 className="font-semibold text-white mb-2">5. Transferencia de Datos</h3>
              <p>
            ...
            <section>
              <h3 className="font-semibold text-white mb-2">6. Derechos del Titular</h3>
              <p>En cumplimiento de la Ley 1581 de 2012, usted tiene derecho a:</p>
              <ul className="mt-2 space-y-1 ml-4 list-disc text-grafito-400">
                <li><strong className="text-grafito-300">Conocer</strong> los datos que REG-X tiene sobre usted</li>
                <li><strong className="text-grafito-300">Actualizar</strong> y corregir su información personal</li>
                <li><strong className="text-grafito-300">Suprimir</strong> sus datos cuando no sean necesarios</li>
                <li><strong className="text-grafito-300">Revocar</strong> la autorización otorgada</li>
                <li><strong className="text-grafito-300">Presentar quejas</strong> ante la Superintendencia de Industria y Comercio (SIC)</li>
              </ul>
            </section>

            <section>
              <h3 className="font-semibold text-white mb-2">7. Vigencia</h3>
              <p>
            ...
            <p className="text-xs text-grafito-600 border-t border-white/5 pt-4">
          ...
          <button
            onClick={onClose}
            className="mt-6 w-full rounded-xl bg-brand-500 py-3 text-sm font-semibold text-white hover:bg-brand-600 transition-colors"
          >
            Entendido
          </button>
        </motion.div>
      ...
      <div className="space-y-5">
        ...
        <AnimatePresence>
          {error && (
            ...
            >
              <div className="flex items-center gap-2.5 rounded-xl border border-red-500/20 bg-red-500/8 px-3.5 py-2.5 text-xs text-red-400">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          {/* Email */}
          <GlassInput>
            <Mail className="h-4 w-4 shrink-0 text-white/25 group-focus-within:text-brand-400 transition-colors" />
            <input
              type="email"
              value={email}
              ...
              autoComplete="email"
              className="flex-1 min-w-0 text-sm text-white placeholder:text-white/30 outline-none"
          ...
          {/* Password */}
          <GlassInput>
            <Key className="h-4 w-4 shrink-0 text-white/25 group-focus-within:text-brand-400 transition-colors" />
            <input
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <label className="flex items-start gap-2 cursor-pointer group select-none flex-1">
              <div className="mt-0.5 shrink-0">
                ...
                />
                <div className="h-4 w-4 rounded-[5px] border border-white/15 bg-white/5 peer-checked:bg-brand-500 peer-checked:border-brand-500 transition-all flex items-center justify-center shadow-sm">
                  {acceptedPolicy && (
              ...
              <span className="text-[11px] text-grafito-600 leading-relaxed">
                Acepto la{' '}
                <button
                  type="button"
                  onClick={() => setShowPolicy(true)}
                  className="text-brand-400 hover:text-brand-300 underline underline-offset-2 font-medium transition-colors"
                >
                  Política de Datos
                </button>{' '}
                (Ley 1581/2012)
            ...
            <button
              ...
              className="shrink-0 text-[11px] text-grafito-600 hover:text-brand-400 transition-colors whitespace-nowrap"
            >
              ¿Olvidaste tu clave?
            </button>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="group relative flex w-full items-center justify-center gap-2 overflow-hidden rounded-2xl bg-brand-500 py-3.5 text-sm font-bold text-white transition-all hover:bg-brand-600 active:scale-[0.98] shadow-lg shadow-brand-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {/* Shine effect */}
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-grafito-700 font-bold uppercase tracking-widest">o continúa con</span>
          <div className="flex-1 border-t border-white/5" />
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="flex w-full items-center justify-center gap-2 rounded-2xl border border-white/[0.07] bg-white/[0.03] py-3 text-sm font-semibold text-grafito-400 hover:bg-white/[0.07] hover:text-white active:scale-[0.98] transition-all disabled:opacity-50"
        >
          Cuenta Demo — acceso sin registro
        </button>

        {/* Register */}
        <p className="text-center text-[11px] text-grafito-700">
          ¿No tienes cuenta?{' '}
          <button
